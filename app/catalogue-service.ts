...
export function bookCover(b:any){const {owner,cover_key,mime,...publicBook}=b;return {...publicBook,cover:!b.cover_key?'':/^\/covers\/pg\d+\.jpg$/.test(b.cover_key)?b.cover_key:'/api/cover?id='+encodeURIComponent(b.id)}}
